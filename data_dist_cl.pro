pro data_dist_cl, root=root, nchain=nchain, fst_ch=fst_ch, nsample=nsample, nforeg=nforeg, tag=tag, do_read=do_read, nband=nband
...
;stop
   ...
   save, filename=tag+'.sav', foreg, cmb, cl, chi2, cmb2
   endif
   ...
   cmb = cmb / nchain / nsample
   cmb2 = cmb2 / nchain / nsample
;stop
   cmbv = sqrt(cmb2-cmb^2)

   write_fits_map, tag+'recCMB_ns16_RING.fits',cmb, /ring,units='!7l!17K'
   write_fits_map, tag+'varCMB_ns16_RING.fits',cmbv, /ring,units='!7l!17K'

   ismoothing,tag+'recCMB_ns16_RING.fits',tag+'recCMB_smth600_ns16_RING.fits', fwhm_arc=600
   ismoothing,tag+'varCMB_ns16_RING.fits',tag+'varCMB_smth600_ns16_RING.fits', fwhm_arc=600
...
;   mollview, tag+'varCMB_smth600_ns16_RING.fits', chars=1.5, tit='!17STDDEV CMB: '+tag
   ...
   read_fits_map, tag+'recCMB_smth600_ns16_RING.fits', smcmb
   read_fits_map, tag+'varCMB_smth600_ns16_RING.fits', smcmbv
...
;;       hist[*,i]=histogram(foreg[0,*,i,4],nbins=bins,locations=a)
   ...
   window, 2 & plot, famp[*,0],hist[*,0]/total(hist[*,0]), psym=10, yr=[0,max(hist)/nsample], xtit='!17A!dff!n', ytit='!17P',xr=[min(famp),max(famp)], chars=1.5
...
;   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/max(hist[*,i]),col=200+i*5,psym=10
   ...
   plot, famp[*,0],hist[*,0]/total(hist[*,0]), psym=10, yr=[0,max(hist)/nsample], xtit='!17A!dff!n', ytit='!17P',xr=[min(famp),max(famp)], chars=1.5
   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/total(hist[*,i]),col=200+i*5,psym=10
;   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/max(hist[*,i]),col=200+i*5,psym=10
   freq = ['30', '44', '70', '100', '143', '217', '353']
   legend, [freq+' GHz'], col=[200, 205, 210, 215, 220, 225, 230], line=[0,0,0,0,0,0,0]
...
;;       hist[*,i]=histogram(foreg[0,*,i,5],nbins=bins,locations=a)
   ...
   window, 7 & plot, famp[*,0],hist[*,0]/total(hist[*,0]), psym=10, yr=[0,max(hist)/nsample], xtit='!17A!dsynch!n', ytit='!17P',xr=[min(famp),max(famp)], chars=1.5
   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/total(hist[*,i]),col=200+i*5,psym=10
;   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/max(hist[*,i]),col=200+i*5,psym=10
   freq = ['30', '44', '70', '100', '143', '217', '353']
   legend, [freq+' GHz'], col=[200, 205, 210, 215, 220, 225, 230], line=[0,0,0,0,0,0,0]
   ...
   plot, famp[*,0],hist[*,0]/total(hist[*,0]), psym=10, yr=[0,max(hist)/nsample], xtit='!17A!dsynch!n', ytit='!17P',xr=[min(famp),max(famp)], chars=1.5
   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/total(hist[*,i]),col=200+i*5,psym=10
;   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/max(hist[*,i]),col=200+i*5,psym=10
   freq = ['30', '44', '70', '100', '143', '217', '353']
   legend, [freq+' GHz'], col=[200, 205, 210, 215, 220, 225, 230], line=[0,0,0,0,0,0,0]
...
;;       hist[*,i]=histogram(foreg[0,*,i,6],nbins=bins,locations=a)
   ...
   window, 5 & plot, famp[*,0],hist[*,0]/total(hist[*,0]), psym=10, yr=[0,max(hist)/nsample], xtit='!17A!dtd!n', ytit='!17P',xr=[min(famp),max(famp)], chars=1.5
   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/total(hist[*,i]),col=200+i*5,psym=10
;   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/max(hist[*,i]),col=200+i*5,psym=10
   freq = ['30', '44', '70', '100', '143', '217', '353']
   legend, [freq+' GHz'], col=[200, 205, 210, 215, 220, 225, 230], line=[0,0,0,0,0,0,0]
   ...
   plot, famp[*,0],hist[*,0]/total(hist[*,0]), psym=10, yr=[0,max(hist)/nsample], xtit='!17A!dtd!n', ytit='!17P',xr=[min(famp),max(famp)], chars=1.5
   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/total(hist[*,i]),col=200+i*5,psym=10
;   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/max(hist[*,i]),col=200+i*5,psym=10
   freq = ['30', '44', '70', '100', '143', '217', '353']
   legend, [freq+' GHz'], col=[200, 205, 210, 215, 220, 225, 230], line=[0,0,0,0,0,0,0]
...
;;       hist[*,i]=histogram(foreg[0,*,i,0],nbins=bins,locations=a)
   ...
   window, 4 & plot, famp[*,0],hist[*,0]/total(hist[*,0]), psym=10, yr=[0,max(hist)/nsample], xtit='!17Monopole', ytit='!17P',xr=[min(famp),max(famp)], chars=1.5
   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/total(hist[*,i]),col=200+i*5,psym=10
;   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/max(hist[*,i]),col=200+i*5,psym=10
   freq = ['30', '44', '70', '100', '143', '217', '353']
   legend, [freq+' GHz'], col=[200, 205, 210, 215, 220, 225, 230], line=[0,0,0,0,0,0,0]
   ...
   plot, famp[*,0],hist[*,0]/total(hist[*,0]), psym=10, yr=[0,max(hist)/nsample], xtit='!17Monopole', ytit='!17P',xr=[min(famp),max(famp)], chars=1.5
   for i=0,nband-1 do oplot, famp[*,i],hist[*,i]/total(hist[*,i]),col=200+i*5,psym=10
...
;stop
   if (nforeg gt 5) then begin
window, 23 &  plot, foreg[0,*,4,0],foreg[0,*,5,0] ,psym=3, xr=[min([foreg[0,*,4,0],foreg[0,*,5,0]]),max([foreg[0,*,4,0],foreg[0,*,5,0]])], yr=[min([foreg[0,*,4,0],foreg[0,*,5,0]]),max([foreg[0,*,4,0],foreg[0,*,5,0]])] 
for ich=fst_ch, fst_ch+nchain-1 do for iba=0,nband-1 do oplot, foreg[ich-1,0:nsample/2-1,4,iba],foreg[ich-1,0:nsample/2-1,5,iba],col=130,psym=3
for ich=fst_ch, fst_ch+nchain-1 do for iba=0,nband-1 do oplot, foreg[ich-1,nsample/2:*,4,iba],foreg[ich-1,nsample/2:*,5,iba],col=90,psym=3
...
if (nforeg gt 6) then begin
window, 24 & plot, foreg[0,*,4,0],foreg[0,*,6,0] ,psym=3, xr=[min([foreg[0,*,4,0],foreg[0,*,6,0]]),max([foreg[0,*,4,0],foreg[0,*,6,0]])], yr=[min([foreg[0,*,4,0],foreg[0,*,6,0]]),max([foreg[0,*,4,0],foreg[0,*,6,0]])]
for ich=fst_ch, fst_ch+nchain-1 do for iba=0,nband-1 do oplot, foreg[ich-1,0:nsample/2-1,4,iba],foreg[ich-1,0:nsample/2-1,6,iba],col=130,psym=3
for ich=fst_ch, fst_ch+nchain-1 do for iba=0,nband-1 do oplot, foreg[ich-1,nsample/2:*,4,iba],foreg[ich-1,nsample/2:*,6,iba],col=90,psym=3
...
window, 25 & plot, foreg[0,*,5,0],foreg[0,*,6,0] ,psym=3, xr=[min([foreg[0,*,5,0],foreg[0,*,6,0]]),max([foreg[0,*,5,0],foreg[0,*,6,0]])], yr=[min([foreg[0,*,5,0],foreg[0,*,6,0]]),max([foreg[0,*,5,0],foreg[0,*,6,0]])]
for ich=fst_ch, fst_ch+nchain-1 do for iba=0,nband-1 do oplot, foreg[ich-1,0:nsample/2-1,5,iba],foreg[ich-1,0:nsample/2-1,6,iba],col=130,psym=3
for ich=fst_ch, fst_ch+nchain-1 do for iba=0,nband-1 do oplot, foreg[ich-1,nsample/2:*,5,iba],foreg[ich-1,nsample/2:*,6,iba],col=90,psym=3
...
;;            ave = total(cl,2) / nsample
;            corr[ich,icl]=total( (cl[ich,0:nsample-1:n,*,*]-ave[ich,*,*]) * (cl[ich,0:nsample-1:n,*,*]-ave[ich,*,*]) )	
   for n=0,clen-2 do begin
      indx = lindgen(nsample-n)
;      for ich=0,nchain-1 do for kcl=0,5 do for icl=2,ncl-1 do corr[n,ich,kcl,icl] = correlate(cl[ich,indx,kcl,icl], cl[ich,indx+n,kcl,icl])
...
;stop
   ...
   ttcl = fltarr(nchain*nsample, 2*(ncl+1))
   i = 0l
   for ichain=0,nchain-1 do for isample=0l,nsample-1 do begin
...
;;        htt[*,icl] = histogram(ttcl[*,icl], locations=a, nbins=bins)
   ...
   window, 6 & 
   !p.multi = [0,4,4]
   lplot = [2,3,4,6,8,10,12,14,16,20,24,28,32];,42,52,62]
...
;   oplot, l, cl70n, col=90, line=2
   ...
   oplot, l, total(cl[0,*,0,*],2)/nsample
