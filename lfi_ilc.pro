...
mapfile = dir+tag+['_Imap_030_ns128_uK.fits', $
               '_Imap_044_ns128_uK.fits', $
               '_Imap_070_ns128_uK.fits'];, $
;               '_Imap_100_ns128_uK.fits', $
...
lfi_ilc = fltarr(npix,3)

for ifreq = 0, nfreq-1 do begin
;##	ilc[gpix] = ilc[gpix] + maps[gpix,ifreq] * gw[ifreq] 
;##        ilc[bpix] = ilc[bpix] + maps[bpix,ifreq] * bw[ifreq]
	lfi_ilc[*,0] = lfi_ilc[*,0] + maps[*,ifreq] * gw[ifreq] 
        lfi_ilc[*,1] = lfi_ilc[*,1] + maps[*,ifreq] * bw[ifreq]
endfor

lfi_ilc[gpix,2] = lfi_ilc[gpix,0]
lfi_ilc[bpix,2] = lfi_ilc[bpix,1]

;write_fits_map, 'ffp4_01a_ILCout.fits', ilc[*,0], /ring, units='!7l!6K'
;write_fits_map, 'ffp4_01a_ILCin.fits', ilc[*,1], /ring, units='!7l!6K'


mollview, lfi_ilc[*,0], min=-300, max=300, chars=1.5, win=1, tit='!6LFI_ILC: wieghts outside mask';, no_monopole=true, gal_cut=40
mollview, lfi_ilc[*,1], min=-300, max=300, chars=1.5, win=2, tit='!6ILC: wieghts inside mask';, no_monopole=true, gal_cut=40
mollview, lfi_ilc[*,2], min=-300, max=300, chars=1.5, win=3, tit='!6ILC: combined';, no_monopole=true, gal_cut=40
mollview, lfi_ilc[*,0]-lfi_ilc[*,1], min=-30, max=30, chars=1.5, win=4, tit='!6LFI_ILC Difference';, no_monopole=true, gal_cut=40
...
if (do_png) then begin
    ...
    mollview, cmb-lfi_ilc[*,0], min=-30, max=30, chars=1.5, win=5, tit='!6Commander-LFI_ILC!dout!n', no_monopole=true, gal_cut=40
    mollview, cmb-lfi_ilc[*,1], min=-30, max=30, chars=1.5, win=6, tit='!6Commander-LFI_ILC!din!n', no_monopole=true, gal_cut=40
    ...
    mollview, lfi_ilc[*,0]-inp, min=-30, max=30, chars=1.5, win=8, tit='!6LFI_ILC!dout!n-Input', no_monopole=true, gal_cut=40
    mollview, lfi_ilc[*,1]-inp, min=-30, max=30, chars=1.5, win=9, tit='!6LFI_ILC!din!n-Input', no_monopole=true, gal_cut=40

    mollview, lfi_ilc[*,0], min=-300, max=300, chars=1.5, win=-1, tit='!6LFI_ILC: wieghts outside mask', no_monopole=true, gal_cut=40, png='ffp4_01a_LFI_ILCout.png'
    mollview, lfi_ilc[*,1], min=-300, max=300, chars=1.5, win=-2, tit='!6LFI_ILC: wieghts inside mask', no_monopole=true, gal_cut=40, png='ffp4_01a_LFI_ILCin.png'
    mollview, lfi_ilc[*,0]-lfi_ilc[*,1], min=-30, max=30, chars=1.5, win=-3, tit='!6LFI_ILC Difference', no_monopole=true, gal_cut=40, png='ffp4_01a_LFI_ILCout-in.png'

    mollview, cmb, min=-300, max=300, chars=1.5, win=-4, tit='!6Commander', no_monopole=true, gal_cut=40, png='ffp4_01a_CMD.png'
    mollview, cmb-lfi_ilc[*,0], min=-30, max=30, chars=1.5, win=-5, tit='!6Commander-LFI_ILC!dout!n', no_monopole=true, gal_cut=40, png='ffp4_01a_CMD-LFI_ILCout.png'
    mollview, cmb-lfi_ilc[*,1], min=-30, max=30, chars=1.5, win=-6, tit='!6Commander-LFI_ILC!din!n', no_monopole=true, gal_cut=40, png='ffp4_01a_CMD-LFI_ILCin.png'

    mollview, cmb-inp, min=-30, max=30, chars=1.5, win=-7, tit='!6Commander-Input', no_monopole=true, gal_cut=40, png='ffp4_01a_CMD-INP.png'
    mollview, lfi_ilc[*,0]-inp, min=-30, max=30, chars=1.5, win=-8, tit='!6LFI_ILC!dout!n-Input', no_monopole=true, gal_cut=40, png='ffp4_01a_LFI_ILCout-INP.png'
    mollview, lfi_ilc[*,1]-inp, min=-30, max=30, chars=1.5, win=-9, tit='!6LFI_ILC!din!n-Input', no_monopole=true, gal_cut=40, png='ffp4_01a_LFI_ILCin-INP.png'
endif
