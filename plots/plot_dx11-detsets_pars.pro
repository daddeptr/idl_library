...
;##   run_tags[1] = 'ds '+freq[irun]+': clean-IN'
;##   run_tags[2] = 'ds '+freq[irun]+': raw'
;##   run_tags[3] = 'ds '+freq[irun]+': clean-OUT'
...
;##   !p.multi = [0,3,ceil(npars/3)]
   ...
   if dops then begin
       set_plot, 'ps'
;##       device, file='dx11_runs-detsets_'+freq[irun]+'.eps', /col, bits=8, /landscape
;##       device, file='dx11_runs-detsets_'+freq[irun]+'_IN.eps', /col, bits=8, /landscape
;##       device, file='dx11_runs-detsets_'+freq[irun]+'_IN_TPcomp.eps', /col, bits=8, /landscape
       device, file='dx11_runs-detsets_allFreq_IN_T.eps', /col, bits=8, /landscape
   endif else begin
