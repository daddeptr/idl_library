...
;## Dropping EE and TE since the beam was the same
           if dops then plot, /nodata, [1,lmax],[0.95,1.05], chars=1.5, xs=1, ys=1, xtit='!8l',ytit='!8D!dl!6!n Ratio', tit=cltag[i], position=[0.075,0.15,0.64,0.85], xlog=xlog else $
             plot, /nodata, [1,lmax],[0.99,1.01], chars=3, xs=1, ys=1, xtit='!8l',ytit='!8D!dl!6!n Ratio / (W!dl!u2!n Ratio)!u-1!n',tit=cltag[i], position=[0.1,0.15,0.64,0.85], xlog=xlog
           oplot, l, wld11*0.+1, line=2;, col=245
;           oplot, l, cl1/cl2
...
;           oplot, l, (cl1/cl5), col=0
           y = bp_binning((wld9/wld11)^2, 'data/bins/ctp/CTP_bin_TT')
           oplot, l, (cl1/cl5) / y;, psym=4
           oplot, l, l*0.+mean( (cl1[50:160]/cl5[50:160])/y[50:160] ), col=230
...
;           oplot, bl, (wlf7/wld11)^2, psym=4, ns=20, col=210
       ...
       xyouts, 0.15, 0.65, '------ 143 undusted-IN: detset1 - detset2 ------', chars=1.5
...
;       xyouts, 0.6, 0.3, '!8W!dl!u2!n!6 ratio.', chars=1.25
       ...
       xyouts, 0.05, 0.8, '(dx11, dx11-beam) vs (dx9-full, dx9-beam)', chars=1.25
       xyouts, 0.05, 0.7, 'Average value ['+strtrim(string(l[50]),2)+','+strtrim(string(l[160]),2)+'] = '+strtrim(string(mean( (cl1[50:160]/cl5[50:160])/y[50:160] )),2), chars=1.25, col=230
