...
;##   chains = strarr(nfiles)
   ...
   chains = [ $
              ...
              'xf_chains_100_T_const2_l1500', $
              'xf_chains_100_T_const2_l1000', $
              'xf_chains_143_T_const2_l2000', $
              'xf_chains_143_T_const2_l1500', $
              'xf_chains_143_T_const2_l1000', $
              'xf_chains_217_T_const2_l2500', $
              'xf_chains_217_T_const2_l1500', $
              'xf_chains_217_T_const2_l1000' $
               ]
...
;       p_range[10,*] = [0, 5]
   ...
   if dops then begin
       set_plot, 'ps'
       device, file='dx11c_likes_Tconsistency_l1000.eps', /col, bits=8, /landscape
   endif else begin
