...
;##   chains = strarr(nfiles)
   ...
   chains = [ $
              'xf_chains_T_const2_largestMask_l1000', $
              'xf_chains_T_const2_largestMask_l1500', $
              'xf_chains_T_const2_largestMask_l2000', $
              'xf_chains_T_const2_largestMask_l3000' $
               ]
