   ...
   dir = [ $
           ...
           '/global/scratch2/sd/dpietrob/Software/XFaster/outputs/', $
           '/global/scratch2/sd/dpietrob/Software/XFaster/CompSep/outputs/dx11_pre/ns2048' $
   ]
   ...
   methods = ['smica_I2048_tau04']

   chains = strarr(nfiles)
   chains[0] = 'base_planck_lowl_lowLike'
   chains[1] = 'xf_chains_T_const2'
   chains[2] = 'xf_chains_smica_I_2048_const2_tau04'
