...
;
            'dx11_pre_year_1-2_Imap_100_full_extMask_545_undusted_insideM_split_ns2048_uK_hrhs_xfcl_l2000_Tmask_x_Pmask_l4000', $
            'dx11_pre_year_1-2_Imap_143_full_extMask_545_undusted_insideM_split_ns2048_uK_hrhs_xfcl_l2500_Tmask_x_Pmask_l4000', $
            'dx11_pre_year_1-2_Imap_217_full_extMask_545_undusted_insideM_split_ns2048_uK_hrhs_xfcl_l2500_Tmask_x_Pmask_l4000', $
;
...
;   run_tags[1] = 'hr 143GHz';: clean-IN'
   run_tags[1] = 'dx: 100GHz';: clean-IN'
   run_tags[2] = 'dx: 143GHz';: clean-IN'
   run_tags[3] = 'dx: 217GHz';: clean-IN'
   run_tags[4] = 'pdx: 100GHz';: clean-IN'
   run_tags[5] = 'pdx: 143GHz';: clean-IN'
   run_tags[6] = 'pdx: 217GHz';: clean-IN'
   run_tags[7] = 'pdx: 100GHz (old)';: clean-IN'
   run_tags[8] = 'pdx: 143GHz (old)';: clean-IN'
   run_tags[9] = 'pdx: 217GHz (old)';: clean-IN'

   colors = [235, 0, 70, 210, 40, 90, 200, 30, 100, 180] ;0, 40, 90, 170 ];, 90, 90];, 70, 100, 100, 100, 210, 210, 210] ;150, 150,180, 180, 0, 0, 120, 120]
...
; setting ps_143 for camb
   ...
   if dops then begin
       set_plot, 'ps'
       device, file='dx11_yr-pars_check.eps', /col, bits=8, /landscape
   endif else begin
