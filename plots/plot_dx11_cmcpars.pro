...
; setting ps_143 for camb
       ...
       save, filename='dx11_cmc-likelihoods.sav', peaks, error, p_range, p_lab, p_key, run_tags
       
   endif else begin

       restore, 'dx11_cmc-likelihoods.sav'
   ...
   if dops then begin
       set_plot, 'ps'
       device, file='dx11_cmc-pars_summary.eps', /col, bits=8, /landscape
   endif else begin
