...
;##       window, 2, xsize=1350, ysize=450
       set_plot, 'ps'
       device, file='preDX11_full_spectra_lowell.eps', /col, bit=8, /landscape
...
;       cl = extract_xfaster_newdata_output(files[0], lcen=l, btcl=tcl, ncl='EE')
       plot, fl, fee, chars=1.5, xr=[1,250], xs=1, xtit='!8l', ytit='!8D!dl!uEE!n [!7l!8K!u2!n]'
       oplot, fl, fee, thick=2
       for i=0,nfiles-1 do begin
           cl = extract_xfaster_newdata_output(files[i], lcen=l, cler=cler, ncl='EE')
           oplot, l, cl, col=colors[i], psym=6
...
;       oplot, fl, fee, thick=2
       device, /close
       set_plot, 'x'
;       write_png, 'preDX11_full_spectra_lowell.png', tvrd(/true)
