...
;##           if not xlog then device, file='newDetset_spectra.eps', /col, bits=8, /landscape else device, file='newDetset_spectra_xlog.eps', /col, bits=8, /landscape
           if not xlog then device, file='beamStudy_predx11_freqSpectra.eps', /col, bits=8, /landscape else device, file='beamStudy_predx11_freqSpectra_xlog.eps', /col, bits=8, /landscape
       endif else begin
...
;##       !p.charsize=1.25
       ...
       xyouts, 0.1, 0.75, '------ preDX11 undusted-IN: detset1 - detset2 ------', chars=1.5
